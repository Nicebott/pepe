...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>$<?php echo number_format($detail['Precio_Unitario'], 2); ?></td>
            <td><?php echo $detail['Cantidad']; ?></td>
            <td>$<?php echo number_format($detail['Precio_Unitario'] * $detail['Cantidad'], 2); ?></td>
        </tr>
        <?php endforeach; ?>
    </tbody>
</table>
...
<?php foreach ($payments as $payment): ?>
    <div class="payment">
        ...
        <p><strong>Monto:</strong> $<?php echo number_format($payment['Monto'], 2); ?></p>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>$<?php echo number_format($detail['Monto'], 2); ?></td>
