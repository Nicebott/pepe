...
<div class="card" style="margin-top: 2rem;">
    ...
    <ul style="color: #7f8c8d; line-height: 2;">
        ...
        <li><strong>Precio:</strong> Ingresa el precio de venta al público</li>
...
document.getElementById('precio').addEventListener('input', function() {
    ...
    if (value && !isNaN(value)) {
        // Opcional: mostrar formato de moneda en tiempo real
        console.log('Precio: $' + parseFloat(value).toFixed(2));
    }
});
